...
const Section2: React.FC<SectionProps> = ({ scrollYProgress }) => {
  ...
  return (
    <motion.section
      style={{ scale, rotate }}
      className='sticky top-0 h-screen flex flex-col items-center justify-center bg-gradient-to-t to-[#1a1919] from-[#06060e] text-white overflow-hidden'
    >
...
const HeroScrollAnimation = forwardRef<HTMLElement>(() => {
